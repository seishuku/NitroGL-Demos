...
Section "Program" SecCopyUI
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN
    ...
    CreateShortCut "$SMPROGRAMS\${MUI_STARTMENU_VARIABLE}\Earth.lnk" "$INSTDIR\Earth.exe"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Earth.c"
  Delete "$INSTDIR\Earth.dsp"
  Delete "$INSTDIR\Earth.dsw"
  Delete "$INSTDIR\Earth.exe"
  ...
  StrCmp ${TEMP1} "" noshortcuts
    Delete "$SMPROGRAMS\${TEMP1}\Earth.lnk"
