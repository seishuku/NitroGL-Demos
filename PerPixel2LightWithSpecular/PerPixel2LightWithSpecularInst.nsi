!define MUI_PRODUCT "Two Per-Pixel Lights with Specular Lighting"
!define MUI_VERSION ""
...
OutFile "PerPixel2LightWithSpecularInst.exe"
...
Section "Program" SecCopyUI
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN
    ...
    CreateShortCut "$SMPROGRAMS\${MUI_STARTMENU_VARIABLE}\Two Per-Pixel Lights with Specular Lighting.lnk" "$INSTDIR\Engine.exe"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\tga.c"
  Delete "$INSTDIR\TilesBase.tga"
  Delete "$INSTDIR\TilesBump.tga"
  ...
  StrCmp ${TEMP1} "" noshortcuts
    Delete "$SMPROGRAMS\${TEMP1}\Two Per-Pixel Lights with Specular Lighting.lnk"
