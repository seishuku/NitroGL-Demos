...
Section "Program" SecCopyUI
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN
    ...
    CreateShortCut "$SMPROGRAMS\${MUI_STARTMENU_VARIABLE}\EMBM.lnk" "$INSTDIR\EMBM.exe"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\embm.c"
  Delete "$INSTDIR\embm.dsp"
  Delete "$INSTDIR\embm.dsw"
  Delete "$INSTDIR\EMBM.exe"
  ...
  StrCmp ${TEMP1} "" noshortcuts
    Delete "$SMPROGRAMS\${TEMP1}\EMBM.lnk"
