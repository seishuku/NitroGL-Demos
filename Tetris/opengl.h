...
extern int GL_ARB_pixel_buffer_object_Flag;
...
extern GLvoid (APIENTRY *glBindRenderbufferEXT)(GLenum target, GLuint renderbuffer);
extern GLvoid (APIENTRY *glDeleteRenderbuffersEXT)(GLsizei n, const GLuint *renderbuffers);
extern GLvoid (APIENTRY *glGenRenderbuffersEXT)(GLsizei n, GLuint *renderbuffers);
extern GLvoid (APIENTRY *glRenderbufferStorageEXT)(GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
extern GLvoid (APIENTRY *glGetRenderbufferParameterivEXT)(GLenum target, GLenum pname, GLint *params);
extern GLboolean (APIENTRY *glIsFramebufferEXT)(GLuint framebuffer);
extern GLvoid (APIENTRY *glBindFramebufferEXT)(GLenum target, GLuint framebuffer);
extern GLvoid (APIENTRY *glDeleteFramebuffersEXT)(GLsizei n, const GLuint *framebuffers);
extern GLvoid (APIENTRY *glGenFramebuffersEXT)(GLsizei n, GLuint *framebuffers);
extern GLenum (APIENTRY *glCheckFramebufferStatusEXT)(GLenum target);
extern GLvoid (APIENTRY *glFramebufferTexture1DEXT)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
extern GLvoid (APIENTRY *glFramebufferTexture2DEXT)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
extern GLvoid (APIENTRY *glFramebufferTexture3DEXT)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset);
extern GLvoid (APIENTRY *glFramebufferRenderbufferEXT)(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
extern GLvoid (APIENTRY *glGetFramebufferAttachmentParameterivEXT)(GLenum target, GLenum attachment, GLenum pname, GLint *params);
extern GLvoid (APIENTRY *glGenerateMipmapEXT)(GLenum target);
extern int GL_EXT_framebuffer_object_Flag;
...
extern int WGL_NV_render_texture_rectangle_Flag;

/* ??? */
extern int WGL_ATI_render_texture_rectangle_Flag;
#else
...
extern GLvoid (APIENTRY *glXBindTexImageATI)(Display *dpy, GLXPbuffer pbuf, int buffer);
extern GLvoid (APIENTRY *glXReleaseTexImageATI)(Display *dpy, GLXPbuffer pbuf, int buffer);
extern GLvoid (APIENTRY *glXDrawableAttribATI)(Display *dpy, GLXDrawable draw, const int *attrib_list);
extern int GLX_ATI_render_texture_Flag;

#define GLX_SAMPLE_BUFFERS_ARB							100000
#define GLX_SAMPLES_ARB									100001

extern int GLX_ARB_multisample_Flag;

#define GLX_RGBA_FLOAT_ATI_BIT							0x00000100

extern int GLX_ATI_pixel_format_float_Flag;

#define GLX_FLOAT_COMPONENTS_NV							0x20B0

extern int GLX_NV_float_buffer_Flag;
#endif
...
#define OGL_RENDER_TEXTURE2D							0x00000008
#define OGL_RENDER_TEXTURECUBE							0x00000010
#define OGL_RENDER_TEXTURERECTANGLE						0x00000020
#define OGL_SAMPLES2X									0x00000040
#define OGL_SAMPLES4X									0x00000080
#define OGL_SAMPLES6X									0x00000100
#define OGL_SAMPLES8X									0x00000200
#define OGL_AUXBUFFERS1									0x00000400
#define OGL_AUXBUFFERS2									0x00000800
#define OGL_AUXBUFFERS3									0x00001000
#define OGL_AUXBUFFERS4									0x00002000
