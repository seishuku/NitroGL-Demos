!define MUI_PRODUCT "Procedural Brick"
!define MUI_VERSION ""
...
Section "Program" SecCopyUI
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN
    ...
    CreateShortCut "$SMPROGRAMS\${MUI_STARTMENU_VARIABLE}\Procedural Brick.lnk" "$INSTDIR\Engine.exe"
...
Section "Uninstall"
  ...
  StrCmp ${TEMP1} "" noshortcuts
    Delete "$SMPROGRAMS\${TEMP1}\Procedural Brick.lnk"
