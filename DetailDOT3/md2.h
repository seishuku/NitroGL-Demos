...
void MD2_DrawFrameDOT3(MD2_Model_t *MD2, int Frame, float lightpos[4]);
void MD2_DrawFrameFurShell(MD2_Model_t *MD2, int Frame, int layer, float length, float lightpos[4]);
void MD2_DrawFrame(MD2_Model_t *MD2, int Frame);
void MD2_DrawVectors(MD2_Model_t *MD2, int Frame);
