!define MUI_PRODUCT "Procedural Water"
!define MUI_VERSION ""
...
Section "Program" SecCopyUI
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN
    ...
    CreateShortCut "$SMPROGRAMS\${MUI_STARTMENU_VARIABLE}\Procedural Water.lnk" "$INSTDIR\Engine.exe"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\RNLCubemap.jpg"
  Delete "$INSTDIR\RNLDiffuseCubemap.tga"
  Delete "$INSTDIR\Spinner.tga"
  Delete "$INSTDIR\Swimmer.tga"
  Delete "$INSTDIR\tga.c"
  Delete "$INSTDIR\Tile.dds"
  ...
  StrCmp ${TEMP1} "" noshortcuts
    Delete "$SMPROGRAMS\${TEMP1}\Procedural Water.lnk"
