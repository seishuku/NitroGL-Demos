...
extern cvar_t gl_truformtess;
extern qboolean TruForm;

PFNGLPNTRIANGLESIATIXPROC glPNTrianglesiATIX;
...
void DoGamma(void)
{
	if(v_gamma.value<0.2)v_gamma.value = 0.2;
	if (v_gamma.value>=1)
	{
		v_gamma.value=1;
		return;
	...
	glColor4f(1.0f, 1.0f, 1.0f, v_gamma.value);
	...
	glBegin(GL_QUADS);
		...
		glVertex3f(11.0f, 100.0f, 100.0f);
		glVertex3f(11.0f, -100.0f, 100.0f);
		glVertex3f(11.0f, -100.0f, -100.0f);
		glVertex3f(11.0f, 100.0f, -100.0f);
	glEnd();
...
lastposenum = posenum;
	...
	while (1)
	{
		...
		do
		{
			...
			glNormal3f(r_avertexnormals[verts->lightnormalindex][0], r_avertexnormals[verts->lightnormalindex][1], r_avertexnormals[verts->lightnormalindex][2]);
...
void R_DrawAliasModel (entity_t *e)
{
	...
	if(TruForm)
	{
		if(ATIX)
		{
			if(gl_truformtess.value)
			{
				glPNTrianglesiATIX(GL_PN_TRIANGLES_TESSELATION_LEVEL_ATIX, (int)gl_truformtess.value);
		...
		else
		{
			if(gl_truformtess.value)
			{
				glPNTrianglesiATI(GL_PN_TRIANGLES_TESSELATION_LEVEL_ATI, (int)gl_truformtess.value);
