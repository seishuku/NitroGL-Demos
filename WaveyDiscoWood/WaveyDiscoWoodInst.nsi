!define MUI_PRODUCT "Wavey Disco Wood"
!define MUI_VERSION ""
...
OutFile "WaveyDiscoWoodInst.exe"
...
Section "Program" SecCopyUI
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN
    ...
    CreateShortCut "$SMPROGRAMS\${MUI_STARTMENU_VARIABLE}\Wavey Disco Wood.lnk" "$INSTDIR\Engine.exe"
