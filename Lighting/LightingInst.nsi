!define MUI_PRODUCT "Mathematical lighting models"
!define MUI_VERSION ""
...
Section "Program" SecCopyUI
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN
    ...
    CreateShortCut "$SMPROGRAMS\${MUI_STARTMENU_VARIABLE}\Mathematical lighting models.lnk" "$INSTDIR\Engine.exe"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Anisotropic.tfp"
  Delete "$INSTDIR\Blinn.tfp"
  ...
  Delete "$INSTDIR\point.tga"
  Delete "$INSTDIR\quat.c"
  Delete "$INSTDIR\quat.h"
  Delete "$INSTDIR\readme.txt"
  Delete "$INSTDIR\tga.c"
  Delete "$INSTDIR\Torus.3ds"
  ...
  StrCmp ${TEMP1} "" noshortcuts
    Delete "$SMPROGRAMS\${TEMP1}\Mathematical lighting models.lnk"
