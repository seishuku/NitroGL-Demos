...
//					glColor4f (l* shadelight[0], l*shadelight[1], l*shadelight[2], alpha);
					glNormal3fv (r_avertexnormals[verts[index_xyz].lightnormalindex]);
...
// =================
	...
	{
		if ( gl_ati_pn_triangles_tesselation->value > 0 )
		{
			glPNTrianglesiATI(GL_PN_TRIANGLES_TESSELATION_LEVEL_ATI, gl_ati_pn_triangles_tesselation->value);
